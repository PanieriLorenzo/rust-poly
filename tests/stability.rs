...
use rust_poly::{
    __util::testing::{
        check_roots, test_case_conj_roots, test_case_roots, RandStreamC64Cartesian,
        RandStreamC64Polar, RandStreamConjugate64, RandStreamR64,
    },
    roots::naive,
    Poly64,
};
...
fn conjugate() {
    ...
    let mut roots_stream = RandStreamC64Polar::new(3, 0.0, 1.0, 0.0, 1.0);
    let mut scale_stream = RandStreamC64Polar::new(4, 1.0, 10.0, 0.0, 1.0);
    for i in 0..1000 {
